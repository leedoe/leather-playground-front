...
class CheckPostPasswordPage extends React.Component {
  state = {
    password: '',
    salt: env.salt
  }
  ...
  onClickSubmit = () => {
    ...
    Axios.put(
      `${process.env.REACT_APP_SERVERURL}/api/posts/${post.pk}/`,
      post
    ).then(response => {
...
export default connect(mapStateToProps)(withStyles(useStyles, { withTheme: true })(withRouter(withSnackbar(CheckPostPasswordPage))));